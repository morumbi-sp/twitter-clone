    ...
    <>
      <NavBox>
        <HeadTitle
          firstLine='please,'
          boldText='Log-in.'
          secondLine='Enjoy your bananas.'
        />
      </NavBox>
      <div className='fixed w-11/12 top-[155px] mx-4 h-fit  overflow-auto bottom-0 bg-gray-100 rounded-3xl py-4 space-y-4 flex flex-col items-center'>
        <div className='w-16 h-16 bg-banana rounded-full mt-5'>
          <svg
        ...
        <form className='w-full px-7 pt-2 pb-8 space-y-8'>
          ...
          <div className='space-y-5 pt-5'>
            ...
            <Button text='Sign up' type='empty' />
          </div>
        </form>
      </div>
    </>
